            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <div class="mb-3">
                        ...
                        <input type="text" name="name" id="name" class="form-control" value="<?=@$model["model_name"]?>" required>
                    </div>
                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Maximális szimulációs iterációk száma
                            (10)</label>
                        <input type="number" class="form-control" id="" name="itter" value="<?=@$model_params["itter"]?>">
                    </div>

                    <div class="mb-3">
                        <label for="exampleInputEmail1" class="form-label">Lambda (1)</label>
                        <input type="number" class="form-control" id="" name="lambda" value="<?=@$model_params["lambda"]?>">
                    </div>
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <select id="disabledSelect" class="form-select" id="" name="transzfer" value="<?=@$model_params["transzfer"]?>">
                ...
                */
                ...
                renderer.on('clickNode', function (e) {
                    ...
                    if (sigmode == 1) {
                        if (sig_start_node) {
                            //reláció ellenörzése #
                            console.log(graph.getEdge(sig_start_node));
